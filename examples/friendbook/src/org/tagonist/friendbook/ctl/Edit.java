 ...
 * $Source: /cvsroot/mav/maverick/examples/friendbook-jsp/javasrc/org/infohazard/friendbook/ctl/Edit.java,v $
 */
...
public class Edit extends Protected
{
	...
	protected String insidePerform() throws Exception
	{
		...
		this.firstName = me.getOldPassword();
		this.lastName = me.getNewPassword();
