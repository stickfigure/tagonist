 ...
 * $Source: /cvsroot/mav/maverick/examples/friendbook-jsp/javasrc/org/infohazard/friendbook/ctl/EditSubmit.java,v $
 */
...
public class EditSubmit extends Edit
{
	...
	protected String insidePerform() throws Exception
	{
		...
		me.setOldPassword(this.firstName);
		me.setNewPassword(this.lastName);
